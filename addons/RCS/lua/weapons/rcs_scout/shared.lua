...
if (CLIENT) then
	SWEP.PrintName			= "M40 scout rifle"	
...
SWEP.Zoom0Cone				= 0.1 --cone when not zoomed
SWEP.Zoom1Cone				= 0.01 --cone when zoomed once
SWEP.Zoom2Cone				= 0.01 --cone when zoomed twice
