...
SWEP.Primary.MaxSpread		= 0.09 --the maximum amount the spread can go by, best left at 0.20 or lower
SWEP.Primary.Handle			= 0.6 --how many seconds you have to wait between each shot before the spread is at its best, adds to the cone as well, between each shot
SWEP.Primary.HandleCut		= 20 --the higher the number, the less it spreads, you may need to increase it with SWEP.Primary.Handle,  as it can effect the spread
SWEP.Primary.SpreadIncrease	= 0.3 --how much you add to the cone after each shot
